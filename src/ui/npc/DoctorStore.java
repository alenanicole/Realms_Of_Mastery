...
public class DoctorStore extends UI{
    GamePanel panel;
    Graphics2D graphics2D;

    public DoctorStore(GamePanel panel) {
        super(panel);
        this.panel = panel;
    }
    ...
    public void draw(Graphics2D graphics2D){
        ...
        graphics2D.drawImage(panel.items[2].image, x + 5, y + 5, panel.tileSize * 2, panel.tileSize * 2, null);
        ...
        x += panel.tileSize;
        y += panel.tileSize;
        text = String.valueOf(panel.items[2].price);
        drawFloat(x, y, text, 5);
        ...
        graphics2D.setColor(border);
        graphics2D.draw(new RoundRectangle2D.Float(x, y, panel.tileSize * 2 + 10 , panel.tileSize * 2 + 10, 5, 5));
        graphics2D.drawImage(panel.items[3].image, x + 5, y + 5, panel.tileSize * 2, panel.tileSize * 2, null);
        if(panel.ui.getPotionNum() == 1){
            graphics2D.setColor(Color.white);
            graphics2D.draw(new RoundRectangle2D.Float(x, y, panel.tileSize * 2 + 10 , panel.tileSize * 2 + 10, 5, 5));
        }
        ...
        x += panel.tileSize;
        y += panel.tileSize;
        text = String.valueOf(panel.items[3].price);
        drawFloat(x, y, text, 5);
        ...
        graphics2D.setColor(border);
        graphics2D.draw(new RoundRectangle2D.Float(x, y, panel.tileSize * 2 + 10 , panel.tileSize * 2 + 10, 5, 5));
        graphics2D.drawImage(panel.items[4].image, x + 5, y + 5, panel.tileSize * 2, panel.tileSize * 2, null);
        if(panel.ui.getPotionNum() == 2){
            graphics2D.setColor(Color.white);
            graphics2D.draw(new RoundRectangle2D.Float(x, y, panel.tileSize * 2 + 10 , panel.tileSize * 2 + 10, 5, 5));
        }
        ...
        x += panel.tileSize;
        y += panel.tileSize;
        text = String.valueOf(panel.items[4].price);
        drawFloat(x, y, text, 5);
        ...
        graphics2D.setColor(border);
        graphics2D.draw(new RoundRectangle2D.Float(x, y, panel.tileSize * 2 + 10 , panel.tileSize * 2 + 10, 5, 5));
        graphics2D.drawImage(panel.items[5].image, x + 5, y + 5, panel.tileSize * 2, panel.tileSize * 2, null);
        if(panel.ui.getPotionNum() == 3){
            graphics2D.setColor(Color.white);
            graphics2D.draw(new RoundRectangle2D.Float(x, y, panel.tileSize * 2 + 10 , panel.tileSize * 2 + 10, 5, 5));
        }
        ...
        x += panel.tileSize;
        y += panel.tileSize;
        text = String.valueOf(panel.items[5].price);
        drawFloat(x, y, text, 5);
        x -= panel.tileSize;
