...
public class PurchaseOutfitScreen extends UI {
    Graphics2D graphics2D;
    GamePanel panel;
    boolean cannotPurchase = false;
    public PurchaseOutfitScreen(GamePanel panel) {
        super(panel);
        this.panel = panel;
    }
    ...
    public void draw(Graphics2D graphics2D) {
        ...
        if(!panel.outfits[panel.ui.getOutfitterNum()].available && panel.items[0].numHeld >= panel.outfits[panel.ui.getOutfitterNum()].price) {
            text = "Would you like to\npurchase this\noutfit?";
            cannotPurchase = false;
        } else if(panel.outfits[panel.ui.getOutfitterNum()].available){
