...
public class PurchasePotionScreen extends UI {
    Graphics2D graphics2D;
    GamePanel panel;
    boolean cannotPurchase = false;
    public PurchasePotionScreen(GamePanel panel) {
        super(panel);
        this.panel = panel;
    }
    ...
    public void draw(Graphics2D graphics2D) {
        ...
        if(panel.items[0].numHeld >= panel.items[panel.ui.getPotionNum() + 2].price) {
